...
ourwordpiece_v7_small = ModelMeta(
    loader=partial(  
        OurInstructModelWrapper,
        trust_remote_code=True,
        model_name = "/mnt/data/ez-workspace/FlagEmbedding/FlagEmbedding/baai_general_embedding/results/retro_ourwordpiece_small_retrieval_2_instruct_stage3_v2_v7_with_inbatch",
        revision="v1",
    ),
    name = "retro_ourwordpiece_small_retrieval_2_instruct_stage3_v2_v7_with_inbatch",
    languages=["fas_Arab"],
    revision="v1",
    release_date="2024-02-10",
    n_parameters=int(149 * 1e6),
